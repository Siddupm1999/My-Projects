...
export const INPUTWRAPPER =
  "flex items-center border border-gray-300 rounded-lg px-3 py-2 focus-within:border-purple-500 focus-within:ring-2 focus-within:ring-purple-100";

export const BUTTON_CLASSES =
  "flex justify-center items-center w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200";
...
// APP.JSX
const name = "John Doe"; // Example name — replace this with actual dynamic data if needed
