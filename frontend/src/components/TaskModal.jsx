  ...
  return (
    <div>
      <div className="fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4">
        <div className="bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadenIn">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-purple-100 rounded-lg transition-colour text-gray-500 hover:text-purple-700"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
