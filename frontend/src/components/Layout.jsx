  ...
  if (error)
    return (
      <div className="min-h-screen bg-gray-50 p-6 flex items-center justify-center">
        <div className="bg-red-50 text-red-600 p-4 rounded-xl border border-red-200 shadow-sm inline-block">
          <p className="font-semibold text-base mb-1">Error loading tasks</p>
          <p className="text-sm mb-3">{error}</p>
          <button
            onClick={fetchTasks}
            className="py-1.5 px-3 bg-red-100 text-red-700 rounded-md text-sm font-medium hover:bg-red-200 transition-colors"
          >
            Try Again
          </button>
        </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                {tasks.slice(0, 3).map((task) => (
                  <div
                    ...
                    className="flex items-center justify-between p-2 sm:p-3 hover: bg-purple-50/50 rounded-lg transition-colors duration-200 border border-transparent hover:bg-purple-100"
                  >
                    ...
                    <span
                      className={`px-2 py-1 text-sm rounded-full shrink-0 ml-2 ${
                        task.completed
